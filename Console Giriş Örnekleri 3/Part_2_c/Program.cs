...
namespace Part_2_c
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Girdiğiniz {0} ve {1} sayısının çarpımı {2} yapar.", sayı1, sayı2, toplam);
            ...
            Console.WriteLine("Girdiğiniz {0} ve {1} sayısının çarpımı {2} yapar.", sayı3, sayı4, toplam2);
            ...
            Console.WriteLine("Girdiğiniz {0} ve {1} sayısının çarpımı {2} yapar.", sayı5, sayı6, toplam3);
            ...
            Console.WriteLine("Girdiğiniz {0} ve {1} sayısının çarpımı {2} yapar.", sayı7, sayı8, toplam4);
